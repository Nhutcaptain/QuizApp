...
const InputComponent = (props: Props) => {
    ...
    const {value, onChange, placeHolder, title, affix, prefix, allowClear, multible, numberOfLine, isPassword, textColor, align, fontSize, fontWeight, textalign, isEditable} = props;
    ...
    return (
            ...
            <RowComponent styles={[globalStyle.inputContainer, 
                ...
                <View style={{flex: 1, paddingLeft: prefix ? 8 : 0, alignItems: align ?? 'flex-start'}}>
                    <TextInput 
                        style={[globalStyle.text,{paddingVertical: 1, textAlignVertical: multible ? 'top' : 'center', color: 'white', fontSize: fontSize ?? 16 , fontWeight: fontWeight ?? 'normal', textAlign: textalign ?? 'left'}]}
